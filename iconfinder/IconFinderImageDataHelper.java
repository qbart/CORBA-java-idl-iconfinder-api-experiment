...
/**
* iconfinder/IconFinderImageDataHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from iconfinder.idl
* Wednesday, February 1, 2012 2:13:19 AM CET
*/

abstract public class IconFinderImageDataHelper
{
  private static String  _id = "IDL:iconfinder/IconFinderImageData:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (iconfinder.IconFinderImageDataHelper.id (), "IconFinderImageData", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    iconfinder.IconFinderImageData value = new iconfinder.IconFinderImageData ();
    value.id = istream.read_long ();
    value.url = istream.read_string ();
